...
class KpisControllerTest < ActionController::TestCase
  ...
  test "should create kpi" do
    assert_difference('Kpi.count') do
      post :create, kpi: { description: @kpi.description, milestone: @kpi.milestone, responsibility: @kpi.responsibility }
    end
  ...
  test "should update kpi" do
    patch :update, id: @kpi, kpi: { description: @kpi.description, milestone: @kpi.milestone, responsibility: @kpi.responsibility }
    assert_redirected_to kpi_path(assigns(:kpi))
  end
